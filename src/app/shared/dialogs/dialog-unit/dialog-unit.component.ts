import { DialogUnitService } from './services/dialog-unit.service';
...
export class DialogUnitComponent implements OnInit {
  ...
  filterData = [];
  constructor(
    private dialogunitSvc: DialogUnitService,
    public dialogRef: MatDialogRef<DialogUnitComponent>,
  ...
  GetunitConvertion(id: String): void {
    this.dialogunitSvc.getUnitConvertion(id).subscribe((resp: any) => {
  ...
  GetItemType(): void {
    this.dialogunitSvc.getItemType().subscribe(resp => {
