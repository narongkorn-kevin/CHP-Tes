...
import { UnitConvertionResponse, UnitConvertion, ItemResponse, LocationResponse, ItemTypeResponse } from '@app/shared/models/base.interface';
import {
  HttpClient,
  HttpRequest,
  HttpHandler,
...
export class DialogUnitConvertionService {
