...
export class DialogItemForInventoryService {
  ...
  getItemLots(ItemID: String): Observable<ItemResponse> {
    return this.http
      .post<any>(`${environment.API_URL}/api/get_item_lot_by_item`, { item_id: ItemID }, this.httpOptions)
      .pipe(catchError(this.handlerError));
  }
