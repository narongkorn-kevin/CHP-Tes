...
export class SaleorderService {
  ...
  getAll(dataTablesParameters: any): Observable<SaleOrderResponse> {
    return this.http
      .post<SaleOrderResponse>(`${environment.API_URL}/api/sale_order_page`, dataTablesParameters, this.httpOptions)
      .pipe(
  ...
  getItemSaleOrder(SOID: String): Observable<ItemResponse> {
    return this.http
      .get<any>(`${environment.API_URL}/api/sale_order/` + SOID, this.httpOptions)
  ...
  getSale(): Observable<EmployeeResponse> {
    return this.http
  ...
  new(Saleorder: FormData): Observable<Location> {
    ...
    return this.http
      .post<Location>(`${environment.API_URL}/api/sale_order`, Saleorder, this.httpOptions)
      .pipe(catchError(this.handlerError));
  }

  approve(saleId: number, status: string): Observable<SaleOrderResponse> {
    return this.http
      .put<SaleOrderResponse>(`${environment.API_URL}/api/approve_sale_order/${saleId}`, { status: status }, this.httpOptions)
      .pipe(catchError(this.handlerError));
  }
