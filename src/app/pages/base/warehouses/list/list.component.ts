import { WarehouseResponse } from './../../../../shared/models/base.interface';
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        that.warehousesSvc.getAll(dataTablesParameters).subscribe((resp) => {
  ...
  onDelete(warehouseId: number): void {
    if (window.confirm('Do you really want remove this data')) {
      this.warehousesSvc
        ...
        .subscribe((res: WarehouseResponse) => {
          if (res.code == 201) {
            this.rerender();
          }
          // this.branchSvc.getAll().subscribe((branch) => {
