...
import { DocResponse } from '@app/shared/models/base.interface';
declare var $: any;
...
export class ListComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        that.docSvc.getAll(dataTablesParameters).subscribe((resp) => {
  ...
  onEdit(data): void {
    ...
    const navigationExtras: NavigationExtras = {
      state: {
        item: {
          ...
          date: '',
          run_number: '',
          controll_number: data.controll_number,
          user_appove: '',
          status: data.status,
          role: '',
        },
    ...
    this.router.navigate(['base/doc/edit'], navigationExtras);
  }
