...
export class ListComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  public prefixRow: any[];

  @ViewChild(MatSort) sort: MatSort;
  constructor(private router: Router, private prefixSvc: PrefixService, private elementRef: ElementRef, private renderer: Renderer2) { }
  ...
  ngOnInit(): void {
    ...
    // };
    this.prefixSvc.getAll().subscribe((prefix) => {
      this.prefixRow = prefix.data;
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/prefix/edit'], navigationExtras);
  }
