...
@Component({
  selector: 'app-edit-pk',
  templateUrl: './edit-pk.component.html',
  styleUrls: ['./edit-pk.component.scss']
})
export class EditPkComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  onUpdate(): void {
    ...
    if (this.actionTODO === Action.EDIT) {
      this.itemSvc.update(formValue.id, formData).subscribe((res) => {
        this.router.navigate(['base/item/list-pk']);
      });
    }
  }
