...
@Component({
  selector: 'app-list-pk',
  templateUrl: './list-pk.component.html',
  styleUrls: ['./list-pk.component.scss']
})
export class ListPkComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        dataTablesParameters['item_type_id'] = 4
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/item/edit-pk', data.id]);
  }
