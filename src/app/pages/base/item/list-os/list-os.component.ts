...
export class ListOsComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        dataTablesParameters['item_type_id'] = 6
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/item/edit-os', data.id]);
  }
