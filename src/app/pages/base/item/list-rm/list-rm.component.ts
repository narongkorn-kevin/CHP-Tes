...
@Component({
  ...
  styleUrls: ['./list-rm.component.scss']
})
export class ListRmComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        dataTablesParameters['item_type_id'] = 3
      ...
      columns: [
        { data: 'No' },
        { data: 'name' },
        { data: 'material_grade.name' },
        { data: 'material_color.name' },
        { data: 'material_manufactu.name' },
        { data: 'qty' },
        { data: 'status' },
        // { data: 'location.name' },
        // { data: 'status' },
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/item/edit-rm', data.id]);
  }
