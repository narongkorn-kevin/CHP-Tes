...
@Component({
  selector: 'app-edit-rm',
  templateUrl: './edit-rm.component.html',
  styleUrls: ['./edit-rm.component.scss']
})
export class EditRmComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  onUpdate(): void {
    ...
    if (this.actionTODO === Action.EDIT) {
      this.itemSvc.update(formValue.id, formData).subscribe((res) => {
        this.router.navigate(['base/item/list-rm']);
      });
    }
  }
