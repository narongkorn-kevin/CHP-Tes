...
@Component({
  selector: 'app-list-fg',
  templateUrl: './list-fg.component.html',
  styleUrls: ['./list-fg.component.scss']
})
export class ListFgComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/item/edit-fg', data.id]);
  }
