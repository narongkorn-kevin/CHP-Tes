...
@Component({
  selector: 'app-edit-sm',
  templateUrl: './edit-sm.component.html',
  styleUrls: ['./edit-sm.component.scss']
})
export class EditSmComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  onUpdate(): void {
    ...
    if (this.actionTODO === Action.EDIT) {
      this.itemSvc.update(formValue.id, formData).subscribe((res) => {
        this.router.navigate(['base/item/list-sm']);
      });
    }
  }
