...
@Component({
  selector: 'app-edit-fs',
  templateUrl: './edit-fs.component.html',
  styleUrls: ['./edit-fs.component.scss']
})
export class EditFsComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  onUpdate(): void {
    ...
    if (this.actionTODO === Action.EDIT) {
      this.itemSvc.update(formValue.id, formData).subscribe((res) => {
        this.router.navigate(['base/item/list-fs']);
      });
    }
  }
