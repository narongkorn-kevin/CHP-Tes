...
export class ListSmComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        dataTablesParameters['item_type_id'] = 2
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/item/edit-sm', data.id]);
  }
