...
export class ListSpComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  loadTable(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        dataTablesParameters['item_type_id'] = 7
  ...
  onEdit(data): void {
    ...
    this.router.navigate(['base/item/edit-sp', data.id]);
  }
