...
import { ForgotPassword } from '@app/shared/models/base.interface';
...
export class ForgotService {
  ...
  new(email: ForgotPassword): Observable<ForgotPassword> {
    return this.http
      .post<ForgotPassword>(`${environment.API_URL}/api/forgot_password_user`, email.email)
      .pipe(catchError(this.handlerError));
  }
