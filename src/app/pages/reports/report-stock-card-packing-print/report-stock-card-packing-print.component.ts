...
declare const M: any;
@Component({
  selector: 'app-report-stock-card-packing-print',
  templateUrl: './report-stock-card-packing-print.component.html',
  styleUrls: ['./report-stock-card-packing-print.component.scss']
})
export class ReportStockCardPackingPrintComponent implements OnInit {
