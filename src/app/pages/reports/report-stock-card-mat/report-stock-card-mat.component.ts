...
declare const M: any;
@Component({
  selector: 'app-report-stock-card-mat',
  templateUrl: './report-stock-card-mat.component.html',
  styleUrls: ['./report-stock-card-mat.component.scss']
})
export class ReportStockCardMatComponent implements OnInit {
