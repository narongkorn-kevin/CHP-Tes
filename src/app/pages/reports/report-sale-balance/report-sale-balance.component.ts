...
declare const M: any;
@Component({
  selector: 'app-report-sale-balance',
  templateUrl: './report-sale-balance.component.html',
  styleUrls: ['./report-sale-balance.component.scss']
})
export class ReportSaleBalanceComponent implements OnInit {
  ...
  loadTable(dataTablesParameters :FormGroup): void {
    ...
    this.saleService.getAll(param).subscribe((resp) => {
