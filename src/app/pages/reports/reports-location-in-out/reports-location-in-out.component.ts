...
declare const M: any;
@Component({
  selector: 'app-reports-location-in-out',
  templateUrl: './reports-location-in-out.component.html',
  styleUrls: ['./reports-location-in-out.component.scss']
})
export class ReportsLocationInOutComponent implements OnInit {
