...
declare const M: any;
@Component({
  selector: 'app-report-stock-card-mat-print',
  templateUrl: './report-stock-card-mat-print.component.html',
  styleUrls: ['./report-stock-card-mat-print.component.scss']
})
export class ReportStockCardMatPrintComponent implements OnInit {
