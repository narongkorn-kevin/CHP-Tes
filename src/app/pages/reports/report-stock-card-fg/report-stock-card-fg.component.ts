...
@Component({
  selector: 'app-report-stock-card-fg',
  templateUrl: './report-stock-card-fg.component.html',
  styleUrls: ['./report-stock-card-fg.component.scss']
})
export class ReportStockCardFgComponent implements OnInit {
